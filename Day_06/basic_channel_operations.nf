...
workflow{
    ...
    if (params.step == 6) {
        ...
        out_ch = in_ch.map { it -> it.reverse() }.view()
    ...
    if (params.step == 8) {
        ...
        out_ch = channel.of("a", "b", "c").concat(ch_1, ch_2).view()
    }
    ...
    if (params.step == 12) {
        ...
        out_ch = left_ch.join(right_ch).view()
    ...
    if (params.step == 13) {
        ...
        result.even.toList().view{"The list of even numbers: $it"}
        result.odd.toList().view{"The list of odd numbers: $it"}
